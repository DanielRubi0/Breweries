...
<form method="POST" action="{{ route ('beers.update', $beer) }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="name" placeholder="Nombre" value="{{ $beer->name }}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <div class="col-1">
            <input type="number" class="form-control" name="vol" id="vol" placeholder="4.5" value="{{ $beer->vol }}">
        </div>
    </div>
    <div class="mb-3">
